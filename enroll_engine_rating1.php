...
// Course configuration - can be extended for other Engine Room courses
$course_config = [
    'engine_rating_1' => [
        'name' => 'ENGINEROOM RATING 1',
        'display_name' => 'Engine Room Rating 1',
        'fee' => 'K10,080.00',
        'start_date' => '02nd February 2026',
        'duration' => '12 Weeks',
        'finish_date' => '01st May 2026',
        'app_open' => '',
        'app_close' => '',
        'app_prefix' => 'ENR-ENG-R1',
        'program_interest' => 'Engine Room Rating 1',
        'sponsor_type' => 'self', // 'self' or 'company'
        'selection_criteria' => [
            'Must provide a recent Character Reference from the current Employer.',
            'Must provide a Disciplinary History Report for the past two (2) years from current Employer.',
            'Must possess Engine Room Rating Class 2 Certificate.',
            'Must have served on a training programme approved by the Administration of not less than 3 years which must include:',
            ...
            'Student MUST PAY 100% of the Full Course Fee immediately upon being given an acceptance letter. Failure to do so will result in the student being denied Admission. Course Fee payment of less than 100% WILL NOT be accepted.'
        ]
    ],
    'engineer_class_5' => [
        'name' => 'ENGINEER CLASS 5',
        'display_name' => 'Engineer Class 5',
        'fee' => 'K10,815.00',
        'start_date' => '31st August 2026',
        'duration' => '11 Weeks',
        'finish_date' => '13th November 2026',
        'app_open' => '09/10/2025',
        'app_close' => '31/07/2026',
        'app_prefix' => 'ENR-ENG-C5',
        'program_interest' => 'Engineer Class 5',
        'sponsor_type' => 'company', // 'self' or 'company'
        'selection_criteria' => [
            'Must provide a recent Character Reference from the Sponsoring Company.',
            'Must provide a Disciplinary History Report for the past two (2) years from the Sponsoring Company.',
            'Must have passed a written and an oral examination conducted by an Examiner.',
            'Sponsoring Company MUST PAY 100% of the Full Course Fee two (2) weeks prior to the commencement of the course. Failure to comply with this requirement will result in the student being denied admission. Course fee payment of less than 100% before admission WILL NOT be accepted.'
        ]
    ],
    'engineer_class_4' => [
        'name' => 'ENGINEER CLASS 4',
        'display_name' => 'Engineer Class 4',
        'fee' => 'K25,431.00',
        'start_date' => '23rd February 2026',
        'duration' => '41 Weeks',
        'finish_date' => '13th November 2026',
        'app_open' => '09/10/2025',
        'app_close' => '30/12/2025',
        'app_prefix' => 'ENR-ENG-C4',
        'program_interest' => 'Engineer Class 4',
        'sponsor_type' => 'company', // 'self' or 'company'
        'selection_criteria' => [
            'Must provide a recent Character Reference from the Sponsoring Company.',
            'Must provide a Disciplinary History Report for the past two (2) years from the Sponsoring Company.',
            'Must possess Engine Class 5 Ticket.',
            'Either :-(a) not less than 12 months at sea as Engineer while holding a Certificate as Engineer Class 5; or (b) not less than 12 months at sea as Engineer on completion of 3 years workshop service acceptable to the Administration; or (c) not less than 3 years training programme approved by the Administration, which must include not less than 6 months at sea as trainee engineer.',
            'Must have passed a written and an oral examination conducted by an Examiner.'
        ]
    ],
    'engineer_class_3' => [
        'name' => 'ENGINEER CLASS 3',
        'display_name' => 'Engineer Class 3',
        'fee' => 'K26,811.00',
        'start_date' => '02nd February 2026',
        'duration' => '41 Weeks',
        'finish_date' => '13th November 2026',
        ...
        'app_prefix' => 'ENR-ENG-C3',
        'program_interest' => 'Engineer Class 3',
        'sponsor_type' => 'company', // 'self' or 'company'
        'selection_criteria' => [
            ...
            '  (b) Not less than 12 months at sea as Engineer on ships of not less than 400kw propulsion power on completion of an engineering apprenticeship acceptable to the Administration; OR',
            '  (c) Not less than 3 years training programme approved by the Administration which must include not less than 12 months at sea as trainee engineer on ships of not less than 400kw propulsion power.',
            'Examination: Must have passed a written and an oral examination conducted by an examiner.',
            'Sponsoring Company MUST PAY 100% of the Full Course Fee two (2) weeks prior to the commencement of the course. Failure to meet this requirement will result in the student being denied Enrolment. Course Fee payment of less than 100% WILL NOT be accepted. Shipping Companies with good payment history in the past are exempted from the pre-payment condition.',
            'Photocopies of Sea time records from CERB must be attached to this application. Failure to provide this record will render the Application incomplete and will not be considered.',
            'Student must pass a Medical Fitness Examination conducted by a National Maritime Safety Authority (NMSA) appointed Medical Doctor. Forms and names of Doctors for this purpose will be provided by PNGMC or the Sponsor Company only when the Student is accepted for Enrolment.',
            'WHERE ALL THE ABOVE ENTRY REQUIREMENTS HAVE BEEN FULLY MET, PREFERENCE FOR ADMISSION WILL BE GIVEN TO STUDENTS WHOSE SPONSORING COMPANY HAS PAID THE FULL COURSE FEE.'
        ]
    ],
    'engineer_class_2_1' => [
        'name' => 'ENGINEER CLASS 2',
        'display_name' => 'Engineer Class 2/1',
        'fee' => 'K31,448.00',
        'start_date' => '02nd February 2026',
        'duration' => '41 Weeks',
        'finish_date' => '13th November 2026',
        'app_open' => '09/10/2025',
        'app_close' => '31/12/2025',
        'app_prefix' => 'ENR-ENG-C2',
        'program_interest' => 'Engineer Class 2/1',
        'sponsor_type' => 'company', // 'self' or 'company'
        'selection_criteria' => [
            'Prerequisite Certificate: Current and valid - Officer in Charge of an engineering watch, Certificate of Competency, having satisfied the following conditions:',
            'Required Sea Service: Evidence and proof of having completed at least 12 months approved seagoing service as Assistant Engineer Officer or Engineer Officer.',
            'Course of Study: For the successful issuance of the Certificate of Competence, each candidate must have satisfactorily completed an appropriate course of study that meets the standard specified in Section A-III/3 of the STCW Code and includes management training and knowledge of the International Safety Management Code, and includes practical training in advanced firefighting in accordance with the provisions of Section A-VI/3 of the STCW Code.',
            'Every Engineer Officer who is qualified to serve as Second Engineer Officer on ships powered by main propulsion power of more, may serve as Chief Engineer Officer on ships powered by main propulsion machinery of less than 3,000kw of main propulsion power, provided that not less than 12 months approved sea-going service shall have been served as an Engineer Officer in a position of responsibility and the Certificate is endorsed.',
            'Pre-requisites: Must hold the following Certificates -',
            ...
            'Examination: Must have passed a written and an oral examination conducted by an examiner.',
            'Sponsoring Company MUST PAY 100% of the Full Course Fee two (2) weeks prior to the commencement of the course. Failure to comply with this requirement will result in the student being denied admission. Course fee payment of less than 100% before admission WILL NOT be accepted.',
            'WHERE ALL THE ABOVE ENTRY REQUIREMENTS HAVE BEEN FULLY MET, PREFERENCE FOR WILL BE GIVEN TO STUDENTS WHOSE SPONSORING COMPANY HAS PAID THE FULL COURSE FEE UPFRONT'
        ]
    ]
];

// Get course from URL parameter, default to engine_rating_1
$course_key = isset($_GET['course']) ? trim($_GET['course']) : 'engine_rating_1';
if (!isset($course_config[$course_key])) {
    $course_key = 'engine_rating_1'; // Fallback to default
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn) {
        ...
        if ($table_check->num_rows === 0) {
            ...
            // Generate application number first (needed for file naming)
            $app_count = 0;
            ...
            $selected_course_key = isset($_POST['course_key']) ? trim($_POST['course_key']) : 'engine_rating_1';
            if (!isset($course_config[$selected_course_key])) {
                $selected_course_key = 'engine_rating_1';
            }
      ...
      <div class="form-section">
        ...
        <div class="form-row">
          <div>
            ...
            <input type="text" name="current_coc_level" placeholder="e.g., Engine Room Rating Class 2" value="<?php echo htmlspecialchars($_POST['current_coc_level'] ?? ''); ?>">
          </div>
          <div>
