...
**Verification:**
- ❌ `PNGMC/.github/workflows/deploy-digitalocean.yml` - **DOES NOT EXIST** (deleted)
- ✅ `.github/workflows/deploy-digitalocean.yml` - **EXISTS** (only active workflow)

**Result:** Only one workflow file exists. The redundant file in PNGMC has been removed.
